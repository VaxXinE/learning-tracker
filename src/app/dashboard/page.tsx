  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        setCourses(coursesData as DashboardCourse[]);
    ...
    const unsubscribeCourses = CourseService.subscribeToCourses(user.uid, (data) => {
      setCourses(data as DashboardCourse[]);
    });
    const unsubscribeTasks = TaskService.subscribeToTasks(user.uid, (data) => {
